...
class UIManager {
    ...
    setupComponentConnections() {
        try {
            ...
            console.log('Назначаю window.app.componentManager:', this.componentManager);
            console.log('Назначаю window.app.stepManager:', this.stepManager);
            console.log('window.app после назначения:', window.app);
    ...
    subscribeToStateChanges() {
        this.appState.subscribe((event) => {
            if (event.detail.type === 'formData') {
                this.updateFormDataDisplay(event.detail.data);
            } else if (event.detail.type === 'calculatorCompleted') {
