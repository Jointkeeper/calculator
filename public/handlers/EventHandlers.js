...
class EventHandlers {
    ...
    handleBeforeUnload(event) {
        ...
        if (this.appState.hasUnsavedChanges && this.appState.hasUnsavedChanges()) {
            event.preventDefault();
            event.returnValue = '';
        }
    }
    ...
    exportData() {
        const data = this.appState.getExportData ? this.appState.getExportData() : (this.appState.getFormData ? this.appState.getFormData() : {});
